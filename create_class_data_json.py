...
def profs_per_levels(
    weapon, spellcasting, armor, fort, reflex, will, saveSpecialization=None
):
    _list = []
    for x in range(20):
        _list.append(
...
def save_to_file(dict_of_lists, fileName):
    ...
    with open(fileName, "w", encoding="utf-8") as f:
        for class_name, class_profs in dict_of_lists.items():
            ...
            proficiencies, save_spec = profs_per_levels(
                saveSpecialization=saveSpecialization, **class_profs
            )
